  ...
  carena.feature = {
    Node : function(obj, options) {
      ...
      return carena.applyProperties(obj, {
        ...
        set y(value) {
          if (obj.event && typeof obj.event.trigger === "function") {
             obj.event.trigger("node.y", {node : obj, oldValue: safe.coords.x, value: value});
          }
          safe.coords.y = value;
          safe.bounds.dirty = true;
          obj.dirty = true;
        ...
        set z(value) {
          if (obj.event && typeof obj.event.trigger === "function") {
             obj.event.trigger("node.z", {node : obj, oldValue: safe.coords.x, value: value});
          }
          safe.coords.z = value;
          safe.bounds.dirty = true;
          obj.dirty = true;
    ...
    Camera : function(obj, options) {
      ...
      document.addEventListener("mousemove", function(ev) {
        ...
        if (target && target.event) {
          if (safe.oldMouseMoveTarget && safe.oldMouseMoveTarget !== target) {
            safe.oldMouseMoveTarget.event.trigger("mouse.out", {target: target, mouse: safe.mouse});
      ...
      document.addEventListener("mousedown", function(ev) {
        if (safe.oldMouseMoveTarget) {
          safe.oldMouseMoveTarget.event.trigger("mouse.down", {
            target: safe.oldMouseMoveTarget,
            mouse: safe.mouse
          });
        }
      ...
      document.addEventListener("mouseup", function(ev) {
        if (safe.oldMouseMoveTarget) {
          safe.oldMouseMoveTarget.event.trigger("mouse.up", {
            target: self.oldMouseMoveTarget,
            mouse: safe.mouse
          });
        }
      });
