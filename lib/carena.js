  ...
  carena.feature = {
    Node : function(obj, options) {
      ...
      return carena.applyProperties(obj, {
        ...
        set parent(value) {
          ...
          if (obj.event) {
            //fobj.event.trigger("node.parent", { node: obj, current: safe.parent, next: value });
          }
    ...
    Camera : function(obj, options) {
      ...
      function mouseMove(ev) {
        ...
        var targets = safe.target.nodesByPoint(safe.mouse.x, safe.mouse.y), i=0, l=targets.length;
