(function(exports) {
  ...
  var carena = {
    Feature : function(name, obj, props) {
    ...
    Build  : function(obj, features, options) {
        ...
        if (typeof features === "function") {
          ...
          for (i=0; i<len; i+=1) {
            if (typeof features[i] === "function") {
              features[i](obj, options, nodeStorage);
            } else {
      ...
      // Naive merge of default features onto the incoming object
  ...
  carena.feature = {
    Node : function(obj, options, storage) {
      options = options || {};
      storage = storage || {};
    ...
    Eventable : function(obj, options, storage) {
      var safe = {
        binds : {},
        sequence : 0
      };
    ...
    Renderer : function(obj, options, storage) {
      storage = storage || {};
    ...
    Camera : function(obj, options, storage) {
      var safe = {
        target : null,
        mouse  : {x:0, y:0},
    ...
    Draggable : function(obj, options, storage) {
      options = options || {};
    ...
    DropTarget : function(obj, options, storage) {
      if (!obj.event) {
        carena.feature.Eventable(obj, options);
      }
    ...
    DropManager : function(obj, options, storage) {
       if (!obj.event) {
          carena.feature.Eventable(obj, options);
       }
    ...
    RelativeToParent : function(obj, options, storage) {
      if (!obj.event) {
        carena.feature.Eventable(obj, options);
      }
